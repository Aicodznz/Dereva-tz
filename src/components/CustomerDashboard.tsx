    ...
    <div className="pb-24 space-y-8">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-xl">Migahawa Maarufu</h3>
          <button className="text-orange-600 text-sm font-bold">View All</button>
        </div>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-xl">Huduma Nyingine</h3>
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-bold text-xl">Bidhaa Maarufu</h3>
          <button className="text-orange-600 text-sm font-bold">View All</button>
        </div>
