                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full pl-8 pr-8 py-2 rounded-xl text-xs font-bold border outline-none ${
                        theme === 'dark'
                          ? 'bg-[#111118] border-neutral-700 text-white placeholder-neutral-500 focus:border-indigo-500'
                          : 'bg-white border-neutral-300 text-neutral-900 placeholder-neutral-400 focus:border-indigo-600'
                      }`}
                    ...
                    {isSearchingGeo && (
                      <Loader2 className="w-4 h-4 absolute right-2.5 top-2.5 text-indigo-500 animate-spin" />
                    )}
                  </div>
